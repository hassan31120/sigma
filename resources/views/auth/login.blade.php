...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('dash/css/material-dashboard.css?v=3.0.0') }}" rel="stylesheet" />
    <style>
        .ahmed:hover{
            ...
            <div class="col-12">
                ...
                <nav
                    ...
                    <div class="container-fluid ps-2 pe-0 text-center">
                        <a class="font-weight-bolder ms-lg-0 ms-3 ahmed" href="{{ url('/') }}" target="_blank">
                            <h3 style="color: white">SIGMA</h3>
                        </a>
                        </div>
                    </div>
                </nav>
