            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 row">
                        ...
                        <div class="col-6" style="position: relative;"><a href="{{ route('admin.service.create') }}"
                                style="position: absolute; left: 2%" class="btn btn-primary">إضافة خدمة جديدة</a></div>
                    </div>
                </div>
                                    ...
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0" style="margin-right:20px">
                                                    <img class="img-thumbnail" src="{{ asset($service->image) }}"
                                                        height="120" width="160" alt="service">
                                                </p>
                                            </td>
