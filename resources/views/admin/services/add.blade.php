            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 row">
                        <div class="col-6">
                            <h5 class="text-white text-capitalize ps-3" style="margin-right: 10px">إضافة خدمة جديدة</h5>
                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">
                                                                <div class="form-outline">
                                                                    ...
                                                                    <textarea name="desc" id="desc" class="form-control form-control-lg formborderCSS" rows="5" required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
