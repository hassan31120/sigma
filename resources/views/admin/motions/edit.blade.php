                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 row">
                        ...
                        <div class="col-6" style="position: relative;"><a href="{{ route('admin.motions') }}"
                                style="position: absolute; left: 2%" class="btn btn-primary">عرض الموشن</a></div>
                    </div>
                </div>
                @if ($app)
                                            ...
                                            <div class="col-12 col-lg-9 col-xl-7">
                                                <div class="card shadow-2-strong card-registration"
                                                    ...
                                                    <div class="card-body p-4 p-md-5">
                                                        <form action="{{ route('admin.motion.update', $app->id) }}"
                                                                ...
                                                                <div class="col-md-12 mb-4">
                                                                    <div class="form-outline">
                                                                        ...
                                                                        <textarea name="desc" id="desc" cols="30" rows="5"
                                                                            class="form-control form-control-lg formborderCSS">{{ $app->desc }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
