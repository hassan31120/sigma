                                                                ...
                                                                <div class="col-md-12 mb-4">
                                                                    <div class="form-outline">
                                                                        <textarea name="desc" id="summernote" cols="30" rows="5"
                                                                            class="form-control form-control-lg formborderCSS" required>{{ $product->desc }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-12 mb-4">
                                                                    <div class="form-outline">
                                                                        <textarea name="ads" id="summernote1" cols="30" rows="5"
                                                                            class="form-control form-control-lg formborderCSS" required>{{ $product->ads }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
